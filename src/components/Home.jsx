  ...
  return (
    <section id="home" className="relative min-h-screen flex items-start justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img src="/Wedding-invitation/assets/cover.jpg" alt="Wedding Cover Photo" className="w-full h-full object-cover translate-y-6 md:translate-y-20" onError={(e)=>{ e.currentTarget.style.display='none'; e.currentTarget.nextElementSibling.style.display='block' }} />
